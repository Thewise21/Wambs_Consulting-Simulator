  ...
  return (
    <div className="step-enter space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-wambs-panel border border-wambs-border rounded-lg p-6 text-center">
            ...
            <span className={`badge badge--${resultat.niveau} inline-block px-4 py-1 mb-4`}>
        ...
        {/* Colonne droite — CTAs + formulaire */}
        <div className="space-y-4">
          ...
          {s.ctaWhatsapp && (
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-3 rounded-xl font-medium btn-outline-gradient transition-colors">
          ...
          {envoye && (
            <div className="hint p-4 text-center text-wambs-muted">
              {s.merci}
            </div>
          )}
      ...
      <div className="text-center pt-4 border-t border-wambs-border">
        ...
        {/* La cle traduite existe dans les trois langues ; en dur, cette ligne
            restait en allemand pour les visiteurs FR et EN. */}
